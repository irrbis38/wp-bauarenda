...
function debounce(l,s){return function(...e){var t=this.lastCall;this.lastCall=Date.now(),t&&this.lastCall-t<=s&&clearTimeout(this.lastCallTimer),this.lastCallTimer=setTimeout(()=>l(...e),s)}}function initCatalog(){const e=document.querySelectorAll(".categories__title"),r=document.querySelectorAll(".categories__group");e.forEach(e=>e.addEventListener("click",i=>{requestAnimationFrame(()=>{{var e;const t=i.target.closest(".categories__title"),l=t.closest(".categories__group"),s=t.nextElementSibling,n=l.classList.contains("active");return void(n?(l.classList.remove("active"),s.style.maxHeight=null):(r.forEach(e=>{e.classList.remove("active");const t=e.children[1];t.style.maxHeight=null}),l.classList.add("active"),s.style.maxHeight=s.scrollHeight+"px"))}})}));const l=document.querySelectorAll(".filters__range");function t(e){let t,l;var s=e.target.classList.contains("filter__inputMin"),n=e.target.classList.contains("filter__inputMax");s?(t=e.target,l=t.nextElementSibling):n&&(l=e.target,t=l.previousElementSibling);const i=t.closest(".filters__block"),r=i.querySelector(".filters__track"),a=i.querySelector(".filters__valueMin"),c=i.querySelector(".filters__valueMax");var n=parseInt(t.value),e=parseInt(l.value);let o;o=l.max-t.min<=10?1:l.max-t.min<=100?3:10,e-n<o?s?t.value=e-o:l.value=n+o:(a.textContent="от "+n,c.textContent="до "+e,s=100*(n-t.min)/(t.max-t.min)+"%",n=100*(l.max-e)/(l.max-l.min)+"%",r.style.left=s,r.style.right=n)}l.forEach(e=>e.addEventListener("input",t));const c=document.querySelector(".filters__current");function u(e){e=e.target.closest(".filters__block");const t=e.children[0].textContent,l=Array.from(c.querySelectorAll(".filters__elem")),s=l.find(e=>e.dataset.filter===t);var n=Boolean(s),i=e.children[2].children[0].textContent,e=e.children[2].children[1].textContent,i=t+` ${i} `+e;if(n)s.children[0].classList.add("animated"),s.children[0].textContent=i;else{e=function(e,t){const l=document.createElement("div");return l.classList.add("filters__elem"),l.dataset.filter=t,l.innerHTML=`
    <span class="filters__elemText">${e}</span>
    ...
    `,l}(i,t);c.prepend(e),c.classList.add("active"),o();const r=c.children[0].children[0],a=(r.addEventListener("animationend",e=>{e.target.classList.remove("animated")}),c.children[0].children[1]);a.addEventListener("click",d)}}function d(e){const t=e.target.closest(".filters__elem"),s=t.dataset.filter;l.forEach(e=>{var t,l;e.dataset.filter===s&&(t=e.classList.contains("filter__inputMin"),l=e.classList.contains("filter__inputMax"),t?(e.value=e.min,n(e)):l&&(e.value=e.max,n(e)))}),t.remove(),i(),o(t.length-1)}function n(e){const t=e.closest(".filters__set").children[0].children[0];t.style.left=0,t.style.right=0}function i(){var e=document.querySelectorAll(".filters__elem");if(!Boolean(e.length)){const t=document.querySelector(".filters__current");t.classList.remove("active")}}l.forEach(e=>e.addEventListener("change",u));const m=document.querySelector(".filters__clear");function o(e=null){let t=0;if(!e){const e=document.querySelectorAll(".filters__elem");t=e.length}const l=document.querySelector(".filters__counter");l.textContent=t}m.addEventListener("click",function(){l.forEach(e=>{var t=e.classList.contains("filter__inputMin");e.value=t?e.min:e.max,n(e)});const e=document.querySelectorAll(".filters__elem");e.forEach(e=>e.remove()),i(),o(0)});const _=document.querySelector(".filters"),s=document.querySelector(".filters__list"),a=document.querySelector(".filters__show");a.addEventListener("mouseenter",()=>{a.classList.add("active"),s.classList.add("visible")}),_.addEventListener("mouseleave",e=>{var t=e.currentTarget.closest(".filters__list"),e=e.currentTarget.closest(".filters__show");t||e||(a.classList.remove("active"),s.classList.remove("visible"))}),window.addEventListener("click",e=>{var t=e.target.closest(".filters__list"),e=e.target.closest(".filters__show");t||e||(a.classList.remove("active"),s.classList.remove("visible"))})}document.addEventListener("DOMContentLoaded",function(){document.querySelector(".catalog")&&initCatalog()});
document.addEventListener("DOMContentLoaded",function(){initHeader(),initHeaderSearch();var e=document.querySelector(".fixed__showField"),e=(e&&initToggleFeedbackField(e),initAnimationShowByScroll(),document.querySelector(".index__page")),e=(e&&(e=document.querySelector(".intro"),initIndexPageIntroSlider(),initToTopButton(e),initReviewsSlider(),initReviewsFullScreen(),initForms()),document.querySelector(".our-partners__page")),e=(e&&(initToTopButton(document.querySelector(".first")),initReviewsSlider(),initReviewsFullScreen(),initForms()),document.querySelector(".qa__page")),e=(e&&(initToTopButton(document.querySelector(".first")),initReviewsSlider(),initReviewsFullScreen(),initForms(),initQAaccordion()),document.querySelector(".our-clients__page")),e=(e&&(initToTopButton(document.querySelector(".first")),initReviewsSlider(),initReviewsFullScreen(),initForms()),document.querySelector(".reviews__page")),e=(e&&(initToTopButton(document.querySelector(".first")),initReviewsFullScreen(),initForms()),document.querySelector(".contacts__page")),e=(e&&(initToTopButton(document.querySelector(".first")),initReviewsSlider(),initReviewsFullScreen(),initForms(),initMap()),document.querySelector(".company__page")),e=(e&&(initToTopButton(document.querySelector(".first")),initReviewsSlider(),initReviewsFullScreen(),initForms()),document.querySelector(".hotline__page")),e=(e&&(initToTopButton(document.querySelector(".first")),initReviewsSlider(),initReviewsFullScreen(),initForms()),document.querySelector(".jobs__page")),e=(e&&(initToTopButton(document.querySelector(".first")),initReviewsSlider(),initReviewsFullScreen(),initForms()),document.querySelector(".licenses__page")),e=(e&&(initToTopButton(document.querySelector(".first")),initReviewsSlider(),initReviewsFullScreen(),initForms()),document.querySelector(".promotions__page")),e=(e&&(initToTopButton(document.querySelector(".first")),initReviewsSlider(),initReviewsFullScreen(),initForms()),document.querySelector(".warranties__page")),e=(e&&(initToTopButton(document.querySelector(".first")),initReviewsSlider(),initReviewsFullScreen(),initForms()),document.querySelector(".catalog__page")),e=(e&&(initToTopButton(document.querySelector(".first")),initReviewsSlider(),initReviewsFullScreen(),initForms(),(e=document.querySelector(".rental__button"))&&initToggleFeedbackField(e)),document.querySelector(".catalog-item-page")),e=(e&&(initToTopButton(document.querySelector(".view")),initReviewsSlider(),initReviewsFullScreen(),initForms(),initViewSlider(),initDetailsTabs(),initBookFormValidation(),initYoutubeVideo(),(e=document.querySelector(".rental__button"))&&initToggleFeedbackField(e)),document.querySelector(".prices__page")),e=(e&&(initToTopButton(document.querySelector(".first")),initReviewsSlider(),initReviewsFullScreen(),initForms()),document.querySelector(".news__page")),e=(e&&(initToTopButton(document.querySelector(".news__title")),initReviewsSlider(),initReviewsFullScreen(),initForms()),document.querySelector(".news-item")),e=(e&&(initToTopButton(document.querySelector(".news-item__title")),initForms(),initSmothScroll()),document.querySelector(".rental__page")),e=(e&&(initToTopButton(document.querySelector(".first")),initReviewsSlider(),initReviewsFullScreen(),initForms(),initQAaccordion(),initYoutubeVideo(),(e=document.querySelector(".rental__button"))&&initToggleFeedbackField(e)),document.querySelector(".services-list__page")),e=(e&&(initToTopButton(document.querySelector(".first")),initReviewsSlider(),initReviewsFullScreen(),initForms(),(e=document.querySelector(".rental__button"))&&initToggleFeedbackField(e)),document.querySelector(".services-item__page"));e&&(initToTopButton(document.querySelector(".first")),initReviewsSlider(),initReviewsFullScreen(),initForms(),initQAaccordion(),(e=document.querySelector(".rental__button"))&&initToggleFeedbackField(e))});const body=document.body;function initHeader(){const t=document.body,i=document.querySelector(".header"),r=document.querySelector(".header__burger"),n=Array.from(document.querySelectorAll(".menu-item-has-children"));function o(e){e.target.classList.add("active")}function c(e){e.target.classList.remove("active")}function s(){n.forEach(e=>{e.addEventListener("mouseenter",o)}),n.forEach(e=>{e.addEventListener("mouseleave",c)})}function l(e){const t=e.target,i=t.closest(".menu-item-has-children");i.classList.contains("active")||e.preventDefault();const r=i.children[1],o=document.querySelectorAll(".menu-item-has-children > .sub-menu");i.classList.contains("active")?(n.forEach(e=>e.classList.remove("active")),r.style.maxHeight=0):(n.forEach(e=>e.classList.remove("active")),o.forEach(e=>e.style.maxHeight=0),i.classList.add("active"),r.style.maxHeight=r.scrollHeight+"px")}function a(){n.forEach(e=>{e.addEventListener("click",l)})}(1280<=window.innerWidth?s:a)();const e=window.matchMedia("(min-width: 1280px)");e.addEventListener("change",function(e){e.matches?(s(),n.forEach(e=>{e.removeEventListener("click",l)}),i.classList.remove("header__fixed"),r.classList.remove("active"),t.classList.remove("lock"),n.forEach(e=>{e.classList.remove("active"),e.children[1].style.maxHeight=e.children[1].scrollHeight+35+"px"})):(n.forEach(e=>{e.removeEventListener("mouseenter",o)}),n.forEach(e=>{e.removeEventListener("mouseleave",c)}),a())}),r.addEventListener("click",()=>{i.classList.toggle("header__fixed"),r.classList.toggle("active"),t.classList.toggle("lock"),n.forEach(e=>{e.classList.remove("active"),e.children[1].style.maxHeight=0})})}function initHeaderSearch(){const e=document.querySelector(".header__search"),t=document.querySelector(".header__search-small"),i=document.querySelector(".header__search-frame"),r=document.querySelector(".header__search-closer"),o=document.querySelector(".header__search-input");var n=()=>{i.classList.add("active"),body.classList.add("lock"),header.classList.remove("header__fixed"),headerBurger.classList.remove("active"),body.classList.remove("lock"),dropdownShow.forEach(e=>{e.classList.remove("active"),e.children[1].style.maxHeight=0}),window.addEventListener("keydown",e=>{"Escape"===e.code&&c()})};const c=()=>{i.classList.remove("active"),body.classList.remove("lock"),o.value="",headerBurger.classList.remove("active")},s=(e.addEventListener("click",n),t.addEventListener("click",n),r.addEventListener("click",c),document.querySelectorAll(".header__search-category"));s.forEach(e=>{e.addEventListener("click",()=>{e.classList.contains("active")||(s.forEach(e=>{e.classList.remove("active")}),e.classList.add("active"))})})}function initToTopButton(e){const t=document.querySelector(".fixed"),i=document.querySelector(".fixed__toTop");let r=document.querySelector(".header").offsetHeight+e.offsetHeight;window.addEventListener("scroll",function(){this.scrollY>r?t.classList.add("show"):t.classList.remove("show")}),i.addEventListener("click",()=>{const e=document.getElementById("top");var t=e.getBoundingClientRect().top;window.scrollBy({top:t,behavior:"smooth"})})}function initToggleFeedbackField(e){const t=document.querySelector("body"),i=document.querySelector(".fixed__feedback"),r=document.querySelector(".fixed__bg"),o=document.querySelector(".fixed__close");function n(){t.classList.remove("lock"),i.classList.remove("active"),r.classList.remove("active")}e.addEventListener("click",()=>{t.classList.add("lock"),i.classList.add("active"),r.classList.add("active")}),[o,r].forEach(e=>e.addEventListener("click",n))}function initAnimationShowByScroll(){let e=new IntersectionObserver(function(e){e.forEach(e=>{e.isIntersecting&&e.target.classList.add("element-show")})},{threshold:[.5]});var t=Array.from(document.querySelectorAll(".element-animation"));if(0<t.length)for(var i of t)e.observe(i)}function initIndexPageIntroSlider(){new Swiper(".intro__slider",{loop:!0,navigation:{nextEl:".intro__next",prevEl:".intro__prev"}})}function initReviewsSlider(){new Swiper(".reviews__slider",{loop:!1,spaceBetween:20,navigation:{nextEl:".reviews__next",prevEl:".reviews__prev"},pagination:{el:".reviews__pagination",type:"bullets",bulletClass:"reviews__dot",bulletActiveClass:"reviews__dot-active",clickable:"true"}})}function initReviewsFullScreen(){const e=document.querySelectorAll(".reviews__preview"),i=document.querySelector(".reviews__fullscreen"),r=document.querySelector(".reviews__fullscreen-img"),o=e=>{e.code="Escape",i.classList.remove("active"),body.classList.remove("lock"),window.removeEventListener("keydown",o)};e.forEach(e=>{e.addEventListener("click",e=>{let t=e.target.closest(".reviews__preview");e=t.firstElementChild.firstElementChild.getAttribute("src");r.setAttribute("src",e),i.classList.add("active"),body.classList.add("lock"),window.addEventListener("keydown",o)})}),i.addEventListener("click",e=>{e.target.classList.contains("reviews__fullscreen-img")||(i.classList.remove("active"),body.classList.remove("lock"))})}function initForms(){const e=document.querySelectorAll(".feedback__form"),t=(e.forEach(t=>{t.addEventListener("submit",e=>{e.preventDefault(),t.elements.name.validity.valid||t.elements.phone.validity.valid?t.elements.name.validity.valid?t.elements.phone.validity.valid?(new FormData(t),t.reset(),t.innerHTML="",t.previousElementSibling.textContent="Спасибо, ваша заявка отправлена. Наш менеджер свяжется с вами в ближайшее время!"):(t.firstElementChild.classList.add("show"),t.children[2].classList.add("error")):(t.firstElementChild.classList.add("show"),t.children[1].classList.add("error")):(t.firstElementChild.classList.add("show"),t.children[1].classList.add("error"),t.children[2].classList.add("error"))})}),document.querySelector(".fixed__form")),i=(t.addEventListener("submit",e=>{e.preventDefault(),t.elements.name.validity.valid||t.elements.phone.validity.valid?t.elements.name.validity.valid?t.elements.phone.validity.valid?(new FormData(t),t.reset(),t.innerHTML='<p class="fixed__after">Спасибо, ваша заявка отправлена.<br>Наш менеджер свяжется с вами в ближайшее время!</p><input type="submit" class="fixed__submit btn__yellow btn__link" value="Отправить" name="submit">'):(t.firstElementChild.classList.add("show"),t.children[2].classList.add("error")):(t.firstElementChild.classList.add("show"),t.children[1].classList.add("error")):(t.firstElementChild.classList.add("show"),t.children[1].classList.add("error"),t.children[2].classList.add("error"))}),document.querySelectorAll(".feedback__name")),r=document.querySelectorAll(".feedback__phone");var o=t=>{t.addEventListener("input",e=>{t.parentElement.classList.remove("error"),t.parentElement.parentElement.children[0].classList.remove("show")})};i.forEach(o),r.forEach(o)}function initQAaccordion(){const o=document.querySelectorAll(".qa__item"),e=document.querySelectorAll(".qa__heading");function t(e){const t=e.target,i=t.closest(".qa__item"),r=i.children[1];i.classList.contains("active")?(i.classList.remove("active"),r.style.maxHeight=null):(o.forEach(e=>{e.classList.remove("active"),e.children[1].style.maxHeight=null}),i.classList.add("active"),r.style.maxHeight=r.scrollHeight+"px"),window.addEventListener("resize",()=>{o.forEach(e=>{e.classList.remove("active"),e.children[1].style.maxHeight=null})})}e.forEach(e=>e.addEventListener("click",t))}function initMap(){const i=document.querySelector(".template__link").textContent+"/contacts/mark.svg";ymaps.ready(function(){var e=[53.94869157061366,27.61157049999995];let t=new ymaps.Map("contactsMap",{center:e,zoom:16});e=new ymaps.Placemark(e,{},{iconLayout:"default#image",iconImageHref:i,iconImageSize:[24,32],iconImageOffset:[-5,-30]}),t.controls.remove("geolocationControl"),t.controls.remove("searchControl"),t.controls.remove("trafficControl"),t.controls.remove("typeSelector"),t.controls.remove("fullscreenControl"),t.controls.remove("zoomControl"),t.controls.remove("rulerControl"),t.geoObjects.add(e)})}function initYoutubeVideo(){const e=document.querySelectorAll(".video__block");e.forEach(t=>{const e=t.dataset.video;const i=e.substring("https://youtu.be/".length,e.length),r=t.querySelector("img");var o="https://i.ytimg.com/vi/"+i+"/maxresdefault.jpg";r.setAttribute("src",o),t.addEventListener("click",e=>{e.preventDefault();e=(e=>{const t=document.createElement("iframe");return t.classList.add("video__iframe"),t.setAttribute("src","https://www.youtube.com/embed/"+e+"?rel=0&showinfo=0&autoplay=1"),t.setAttribute("title","YouTube video player"),t.setAttribute("frameborder","0"),t.setAttribute("allowfullscreen",""),t.setAttribute("allow","accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope;"),t})(i);t.querySelector("img").remove(),t.querySelector("button").remove(),t.append(e)})})}function initViewSlider(){var e=new Swiper(".view__slider",{loop:!1,spaceBetween:10,grabCursor:!0,slidesPerView:2,freeMode:!0,watchSlidesProgress:!0,breakpoints:{480:{spaceBetween:10,slidesPerView:3},576:{spaceBetween:10,slidesPerView:4},767:{slidesPerView:4,spaceBetween:30},1024:{slidesPerView:3},1280:{slidesPerView:4}}});new Swiper(".view__fullsize",{effect:"fade",navigation:{nextEl:".view__next",prevEl:".view__prev"},thumbs:{swiper:e}})}function initDetailsTabs(){const i=Array.from(document.querySelectorAll(".description__button")),r=Array.from(document.querySelectorAll(".description__item"));i.forEach(t=>t.addEventListener("click",()=>{if(!t.classList.contains("active")){const e=i.indexOf(t);requestAnimationFrame(()=>{i.forEach(e=>e.classList.remove("active")),r.forEach(e=>e.classList.remove("show")),i[e].classList.add("active"),r[e].classList.add("show")})}}))}function initBookFormValidation(){const t=document.querySelector(".book__form"),i=document.querySelector(".book__item");t.addEventListener("submit",e=>{e.preventDefault(),t.elements.phone.validity.valid?(new FormData(t),t.reset()):i.classList.add("error")}),i.children[1].addEventListener("input",()=>{i.classList.remove("error")})}function initSmothScroll(){const i=Array.from(document.querySelectorAll(".news-item__list li a")),r=Array.from(document.querySelectorAll(".news-item__block"));function t(e){e.preventDefault();e=i.indexOf(e.target);const t=r[e];e=t.getBoundingClientRect().top;window.scrollBy({top:e,behavior:"smooth"})}i.forEach(e=>e.addEventListener("click",t))}