...
document.addEventListener("DOMContentLoaded",function(){initHeader(),initHeaderSearch(),initToTopButton(),initToggleFeedbackField(),initAnimationShowByScroll();document.querySelector(".index__page")&&initIndexPage();var e=document.querySelector(".catalog");e&&initCatalog()});const body=document.body;function initHeader(){const t=document.body,s=document.querySelector(".header"),i=document.querySelector(".header__burger"),r=Array.from(document.querySelectorAll(".dropdown_show"));function c(e){e.target.classList.add("active")}function a(e){e.target.classList.remove("active")}function o(){r.forEach(e=>{e.addEventListener("mouseenter",c)}),r.forEach(e=>{e.addEventListener("mouseleave",a)})}function n(e){e.preventDefault();const t=e.target,s=t.closest(".dropdown_show"),i=s.children[1];s.classList.contains("active")?(r.forEach(e=>e.classList.remove("active")),i.style.maxHeight=0):(r.forEach(e=>e.classList.remove("active")),s.classList.add("active"),i.style.maxHeight=i.scrollHeight+"px")}function l(){r.forEach(e=>{e.addEventListener("click",n)})}(1280<=window.innerWidth?o:l)();const e=window.matchMedia("(min-width: 1280px)");e.addEventListener("change",function(e){e.matches?(o(),r.forEach(e=>{e.removeEventListener("click",n)}),s.classList.remove("header__fixed"),i.classList.remove("active"),t.classList.remove("lock"),r.forEach(e=>{e.classList.remove("active"),e.children[1].style.maxHeight=e.children[1].scrollHeight+35+"px"})):(r.forEach(e=>{e.removeEventListener("mouseenter",c)}),r.forEach(e=>{e.removeEventListener("mouseleave",a)}),l())}),i.addEventListener("click",()=>{s.classList.toggle("header__fixed"),i.classList.toggle("active"),t.classList.toggle("lock"),r.forEach(e=>{e.classList.remove("active"),e.children[1].style.maxHeight=0})})}function initHeaderSearch(){const e=document.querySelector(".header__search"),t=document.querySelector(".header__search-small"),s=document.querySelector(".header__search-frame"),i=document.querySelector(".header__search-closer"),r=document.querySelector(".header__search-input");var c=()=>{s.classList.add("active"),body.classList.add("lock"),header.classList.remove("header__fixed"),headerBurger.classList.remove("active"),body.classList.remove("lock"),dropdownShow.forEach(e=>{e.classList.remove("active"),e.children[1].style.maxHeight=0}),window.addEventListener("keydown",e=>{"Escape"===e.code&&a()})};const a=()=>{s.classList.remove("active"),body.classList.remove("lock"),r.value="",headerBurger.classList.remove("active")},o=(e.addEventListener("click",c),t.addEventListener("click",c),i.addEventListener("click",a),document.querySelectorAll(".header__search-category"));o.forEach(e=>{e.addEventListener("click",()=>{e.classList.contains("active")||(o.forEach(e=>{e.classList.remove("active")}),e.classList.add("active"))})})}function initToTopButton(){const e=document.querySelector(".fixed"),t=document.querySelector(".fixed__toTop");var s=document.querySelector(".header"),i=document.querySelector(".intro");let r=s.offsetHeight+i.offsetHeight;window.addEventListener("scroll",function(){this.scrollY>r?e.classList.add("show"):e.classList.remove("show")}),t.addEventListener("click",()=>{const e=document.getElementById("top");var t=e.getBoundingClientRect().top;window.scrollBy({top:t,behavior:"smooth"})})}function initToggleFeedbackField(){const e=document.querySelector("body"),t=document.querySelector(".fixed__showField"),s=document.querySelector(".fixed__feedback"),i=document.querySelector(".fixed__bg"),r=document.querySelector(".fixed__close");t.addEventListener("click",()=>{e.classList.add("lock"),s.classList.add("active"),i.classList.add("active")}),r.addEventListener("click",()=>{e.classList.remove("lock"),s.classList.remove("active"),i.classList.remove("active")})}function initAnimationShowByScroll(){let e=new IntersectionObserver(function(e){e.forEach(e=>{e.isIntersecting&&e.target.classList.add("element-show")})},{threshold:[.5]});var t=Array.from(document.querySelectorAll(".element-animation"));if(0<t.length)for(var s of t)e.observe(s)}function initIndexPage(){new Swiper(".swiper",{loop:!0,navigation:{nextEl:".intro__next",prevEl:".intro__prev"}}),new Swiper(".swiper",{loop:!0,navigation:{nextEl:".reviews__next",prevEl:".reviews__prev"},pagination:{el:".reviews__pagination",type:"bullets",bulletClass:"reviews__dot",bulletActiveClass:"reviews__dot-active",clickable:"true"}});const e=document.querySelectorAll(".reviews__preview"),s=document.querySelector(".reviews__fullscreen"),i=document.querySelector(".reviews__fullscreen-img"),r=e=>{e.code="Escape",s.classList.remove("active"),body.classList.remove("lock"),window.removeEventListener("keydown",r)},t=(e.forEach(e=>{e.addEventListener("click",e=>{let t=e.target.closest(".reviews__preview");e=t.firstElementChild.firstElementChild.getAttribute("src");i.setAttribute("src",e),s.classList.add("active"),body.classList.add("lock"),window.addEventListener("keydown",r)})}),s.addEventListener("click",e=>{e.target.classList.contains("reviews__fullscreen-img")||(s.classList.remove("active"),body.classList.remove("lock"))}),document.querySelectorAll(".feedback__form")),c=(t.forEach(t=>{t.addEventListener("submit",e=>{e.preventDefault(),t.elements.name.validity.valid||t.elements.phone.validity.valid?t.elements.name.validity.valid?t.elements.phone.validity.valid?(new FormData(t),t.reset(),t.innerHTML="",t.previousElementSibling.textContent="Спасибо, ваша заявка отправлена. Наш менеджер свяжется с вами в ближайшее время!"):(t.firstElementChild.classList.add("show"),t.children[2].classList.add("error")):(t.firstElementChild.classList.add("show"),t.children[1].classList.add("error")):(t.firstElementChild.classList.add("show"),t.children[1].classList.add("error"),t.children[2].classList.add("error"))})}),document.querySelector(".fixed__form")),a=(c.addEventListener("submit",e=>{e.preventDefault(),c.elements.name.validity.valid||c.elements.phone.validity.valid?c.elements.name.validity.valid?c.elements.phone.validity.valid?(new FormData(c),c.reset(),c.innerHTML='<p class="fixed__after">Спасибо, ваша заявка отправлена.<br>Наш менеджер свяжется с вами в ближайшее время!</p><input type="submit" class="fixed__submit btn__yellow btn__link" value="Отправить" name="submit">'):(c.firstElementChild.classList.add("show"),c.children[2].classList.add("error")):(c.firstElementChild.classList.add("show"),c.children[1].classList.add("error")):(c.firstElementChild.classList.add("show"),c.children[1].classList.add("error"),c.children[2].classList.add("error"))}),document.querySelectorAll(".feedback__name")),o=document.querySelectorAll(".feedback__phone");var n=t=>{t.addEventListener("input",e=>{t.parentElement.classList.remove("error"),t.parentElement.parentElement.children[0].classList.remove("show")})};a.forEach(n),o.forEach(n)}function initCatalog(){const t=Array.from(document.querySelectorAll(".catalog__category")),s=document.querySelector(".catalog__sort");t.forEach(e=>e.addEventListener("click",e=>{e.target.classList.contains("active")||(t.forEach(e=>e.classList.remove("active")),e.target.classList.add("active"))})),s.addEventListener("mouseenter",()=>{s.classList.add("active")}),s.addEventListener("mouseleave",()=>{s.classList.remove("active")});{const r=document.querySelectorAll(".catalog__sort-item");r.forEach(e=>e.addEventListener("click",i))}const e=Array.from(document.querySelectorAll(".catalog__sort-item"));function i(e){const t=document.querySelector(".catalog__sort-type");var s=e.target.dataset.text;e.target.dataset.type;t.textContent!==s&&(t.textContent=s)}e.forEach(e=>e.addEventListener("click",()=>s.classList.remove("active")))}