...
document.addEventListener("DOMContentLoaded",function(){initHeader(),initHeaderSearch(),initToggleFeedbackField(),initAnimationShowByScroll();document.querySelector(".index__page")&&(e=document.querySelector(".intro"),initIndexPageIntroSlider(),initToTopButton(e),initReviewsSlider(),initReviewsFullScreen(),initForms());var e=document.querySelector(".our-partners__page"),e=(e&&(initToTopButton(document.querySelector(".first")),initReviewsSlider(),initReviewsFullScreen(),initForms()),document.querySelector(".qa__page")),e=(e&&(initToTopButton(document.querySelector(".first")),initReviewsSlider(),initReviewsFullScreen(),initForms(),initQAaccordion()),document.querySelector(".our-clients__page")),e=(e&&(initToTopButton(document.querySelector(".first")),initReviewsSlider(),initReviewsFullScreen(),initForms()),document.querySelector(".reviews__page"));e&&(initToTopButton(document.querySelector(".first")),initReviewsFullScreen(),initForms())});const body=document.body;function initHeader(){const t=document.body,i=document.querySelector(".header"),s=document.querySelector(".header__burger"),n=Array.from(document.querySelectorAll(".menu-item-has-children"));function r(e){e.target.classList.add("active")}function c(e){e.target.classList.remove("active")}function o(){n.forEach(e=>{e.addEventListener("mouseenter",r)}),n.forEach(e=>{e.addEventListener("mouseleave",c)})}function l(e){const t=e.target,i=t.closest(".menu-item-has-children");i.classList.contains("active")||e.preventDefault();const s=i.children[1],r=document.querySelectorAll(".menu-item-has-children > .sub-menu");i.classList.contains("active")?(n.forEach(e=>e.classList.remove("active")),s.style.maxHeight=0):(n.forEach(e=>e.classList.remove("active")),r.forEach(e=>e.style.maxHeight=0),i.classList.add("active"),s.style.maxHeight=s.scrollHeight+"px")}function a(){n.forEach(e=>{e.addEventListener("click",l)})}(1280<=window.innerWidth?o:a)();const e=window.matchMedia("(min-width: 1280px)");e.addEventListener("change",function(e){e.matches?(o(),n.forEach(e=>{e.removeEventListener("click",l)}),i.classList.remove("header__fixed"),s.classList.remove("active"),t.classList.remove("lock"),n.forEach(e=>{e.classList.remove("active"),e.children[1].style.maxHeight=e.children[1].scrollHeight+35+"px"})):(n.forEach(e=>{e.removeEventListener("mouseenter",r)}),n.forEach(e=>{e.removeEventListener("mouseleave",c)}),a())}),s.addEventListener("click",()=>{i.classList.toggle("header__fixed"),s.classList.toggle("active"),t.classList.toggle("lock"),n.forEach(e=>{e.classList.remove("active"),e.children[1].style.maxHeight=0})})}function initHeaderSearch(){const e=document.querySelector(".header__search"),t=document.querySelector(".header__search-small"),i=document.querySelector(".header__search-frame"),s=document.querySelector(".header__search-closer"),r=document.querySelector(".header__search-input");var n=()=>{i.classList.add("active"),body.classList.add("lock"),header.classList.remove("header__fixed"),headerBurger.classList.remove("active"),body.classList.remove("lock"),dropdownShow.forEach(e=>{e.classList.remove("active"),e.children[1].style.maxHeight=0}),window.addEventListener("keydown",e=>{"Escape"===e.code&&c()})};const c=()=>{i.classList.remove("active"),body.classList.remove("lock"),r.value="",headerBurger.classList.remove("active")},o=(e.addEventListener("click",n),t.addEventListener("click",n),s.addEventListener("click",c),document.querySelectorAll(".header__search-category"));o.forEach(e=>{e.addEventListener("click",()=>{e.classList.contains("active")||(o.forEach(e=>{e.classList.remove("active")}),e.classList.add("active"))})})}function initToTopButton(e){const t=document.querySelector(".fixed"),i=document.querySelector(".fixed__toTop");let s=document.querySelector(".header").offsetHeight+e.offsetHeight;window.addEventListener("scroll",function(){this.scrollY>s?t.classList.add("show"):t.classList.remove("show")}),i.addEventListener("click",()=>{const e=document.getElementById("top");var t=e.getBoundingClientRect().top;window.scrollBy({top:t,behavior:"smooth"})})}function initToggleFeedbackField(){const e=document.querySelector("body"),t=document.querySelector(".fixed__showField"),i=document.querySelector(".fixed__feedback"),s=document.querySelector(".fixed__bg"),r=document.querySelector(".fixed__close");t.addEventListener("click",()=>{e.classList.add("lock"),i.classList.add("active"),s.classList.add("active")}),r.addEventListener("click",()=>{e.classList.remove("lock"),i.classList.remove("active"),s.classList.remove("active")})}function initAnimationShowByScroll(){let e=new IntersectionObserver(function(e){e.forEach(e=>{e.isIntersecting&&e.target.classList.add("element-show")})},{threshold:[.5]});var t=Array.from(document.querySelectorAll(".element-animation"));if(0<t.length)for(var i of t)e.observe(i)}function initIndexPageIntroSlider(){new Swiper(".intro__slider",{loop:!0,navigation:{nextEl:".intro__next",prevEl:".intro__prev"}})}function initReviewsSlider(){new Swiper(".reviews__slider",{loop:!1,spaceBetween:20,navigation:{nextEl:".reviews__next",prevEl:".reviews__prev"},pagination:{el:".reviews__pagination",type:"bullets",bulletClass:"reviews__dot",bulletActiveClass:"reviews__dot-active",clickable:"true"}})}function initReviewsFullScreen(){const e=document.querySelectorAll(".reviews__preview"),i=document.querySelector(".reviews__fullscreen"),s=document.querySelector(".reviews__fullscreen-img"),r=e=>{e.code="Escape",i.classList.remove("active"),body.classList.remove("lock"),window.removeEventListener("keydown",r)};e.forEach(e=>{e.addEventListener("click",e=>{let t=e.target.closest(".reviews__preview");e=t.firstElementChild.firstElementChild.getAttribute("src");s.setAttribute("src",e),i.classList.add("active"),body.classList.add("lock"),window.addEventListener("keydown",r)})}),i.addEventListener("click",e=>{e.target.classList.contains("reviews__fullscreen-img")||(i.classList.remove("active"),body.classList.remove("lock"))})}function initForms(){const e=document.querySelectorAll(".feedback__form"),t=(e.forEach(t=>{t.addEventListener("submit",e=>{e.preventDefault(),t.elements.name.validity.valid||t.elements.phone.validity.valid?t.elements.name.validity.valid?t.elements.phone.validity.valid?(new FormData(t),t.reset(),t.innerHTML="",t.previousElementSibling.textContent="Спасибо, ваша заявка отправлена. Наш менеджер свяжется с вами в ближайшее время!"):(t.firstElementChild.classList.add("show"),t.children[2].classList.add("error")):(t.firstElementChild.classList.add("show"),t.children[1].classList.add("error")):(t.firstElementChild.classList.add("show"),t.children[1].classList.add("error"),t.children[2].classList.add("error"))})}),document.querySelector(".fixed__form")),i=(t.addEventListener("submit",e=>{e.preventDefault(),t.elements.name.validity.valid||t.elements.phone.validity.valid?t.elements.name.validity.valid?t.elements.phone.validity.valid?(new FormData(t),t.reset(),t.innerHTML='<p class="fixed__after">Спасибо, ваша заявка отправлена.<br>Наш менеджер свяжется с вами в ближайшее время!</p><input type="submit" class="fixed__submit btn__yellow btn__link" value="Отправить" name="submit">'):(t.firstElementChild.classList.add("show"),t.children[2].classList.add("error")):(t.firstElementChild.classList.add("show"),t.children[1].classList.add("error")):(t.firstElementChild.classList.add("show"),t.children[1].classList.add("error"),t.children[2].classList.add("error"))}),document.querySelectorAll(".feedback__name")),s=document.querySelectorAll(".feedback__phone");var r=t=>{t.addEventListener("input",e=>{t.parentElement.classList.remove("error"),t.parentElement.parentElement.children[0].classList.remove("show")})};i.forEach(r),s.forEach(r)}function initQAaccordion(){const r=document.querySelectorAll(".qa__item"),e=document.querySelectorAll(".qa__heading");function t(e){const t=e.target,i=t.closest(".qa__item"),s=i.children[1];i.classList.contains("active")?(i.classList.remove("active"),s.style.maxHeight=null):(r.forEach(e=>{e.classList.remove("active"),e.children[1].style.maxHeight=null}),i.classList.add("active"),s.style.maxHeight=s.scrollHeight+"px"),window.addEventListener("resize",()=>{r.forEach(e=>{e.classList.remove("active"),e.children[1].style.maxHeight=null})})}e.forEach(e=>e.addEventListener("click",t))}