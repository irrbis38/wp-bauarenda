	...
	<section class="catalog">
		<div class="container">
			...
			<div class="catalog__nav">
				...
				<div class="catalog__sort"><span class="catalog__sort-type">Сортировать по</span><img class="catalog__arrow"
						src="<?php echo bloginfo( 'template_url' ); ?>/assets/images/catalog/arrow-down.svg" alt="">
					<div class="catalog__sort-list">
						<p class="catalog__sort-item" data-type="popularity" data-text="По популярности">Популярности</p>
						<p class="catalog__sort-item" data-type="fromMinToMax" data-text="По возрастанию">Возрастанию цены</p>
						<p class="catalog__sort-item" data-type="fromMaxToMin" data-text="По убыванию">Убыванию цены</p>
					</div>
				</div>
			</div>
      ...
      <?php
          ...
          ?>
              <div class="catalog__item">
                ...
                <div class="catalog__info">
                  <h4 class="catalog__header"><?php the_title(); ?></h4>

                  <div class="catalog__options">
                    <div class="catalog__feature">
                    <p class="catalog__name"><?php echo get_field('catalog__name1'); ?></p>
                    <p class="catalog__value"><?php echo get_field('catalog__value1'); ?></p>
                    </div>

                    <div class="catalog__feature">
                    <p class="catalog__name"><?php echo get_field('catalog__name2'); ?></p>
                    <p class="catalog__value"><?php echo get_field('catalog__value2'); ?></p>
                    </div>

                    <div class="catalog__feature">
                    <p class="catalog__name"><?php echo get_field('catalog__name3'); ?></p>
                    <p class="catalog__value"><?php echo get_field('catalog__value3'); ?></p>
                    </div>
                  </div>

                  <p class="catalog__price"><?php echo get_field('catalog__price'); ?> BYN</p>
                </div>
          ...
          ?>
            ...
            <div class="page-info-ajax" style="display:none;">
              <p class="max_pages"><?php echo $query->max_num_pages; ?></p>
            </div>
          ...
          <a class="catalog__link" href="#"></a>
					<div class="catalog__img"><img src="<?php echo bloginfo( 'template_url' ); ?>/assets/images/catalog/1.jpg" alt="Аренда экскаваторов CATERPILLAR" /></div><a
						class="catalog__button" href="#">Подробнее</a>
					<div class="catalog__info">
						<h4 class="catalog__header">Аренда экскаваторов CATERPILLAR</h4>
						<div class="catalog__options">
							<div class="catalog__feature">
								<p class="catalog__name">Объём фронтального ковша</p>
								<p class="catalog__value">1,3 м3</p>
							</div>
							<div class="catalog__feature">
								<p class="catalog__name">Высота выгрузки</p>
								<p class="catalog__value">2690 мм</p>
							</div>
							<div class="catalog__feature">
								<p class="catalog__name">Мощность двигателя</p>
								<p class="catalog__value">100 л.с.</p>
							</div>
						</div>
						<p class="catalog__price">150BYN</p>
					</div>
				</div>
				<div class="catalog__item"><a class="catalog__link" href="#"></a>
					<div class="catalog__img"><img src="<?php echo bloginfo( 'template_url' ); ?>/assets/images/catalog/2.jpg" alt="Аренда самосвалов CATERPILLAR" /></div><a
						class="catalog__button" href="#">Подробнее</a>
					<div class="catalog__info">
						<h4 class="catalog__header">Аренда самосвалов CATERPILLAR</h4>
						<div class="catalog__options">
							<div class="catalog__feature">
								<p class="catalog__name">Объём фронтального ковша</p>
								<p class="catalog__value">1,3 м3</p>
				...
				<div class="catalog__item"><a class="catalog__link" href="#"></a>
					...
					<div class="catalog__info">
						...
						<p class="catalog__price">100BYN</p>
					</div>
				</div>
				<div class="catalog__item"><a class="catalog__link" href="#"></a>
					<div class="catalog__img"><img src="<?php echo bloginfo( 'template_url' ); ?>/assets/images/catalog/3.jpg" alt="Аренда бульдозеров CATERPILLAR" /></div><a
						class="catalog__button" href="#">Подробнее</a>
					<div class="catalog__info">
						<h4 class="catalog__header">Аренда бульдозеров CATERPILLAR</h4>
						<div class="catalog__options">
							<div class="catalog__feature">
								<p class="catalog__name">Объём фронтального ковша</p>
								<p class="catalog__value">1,3 м3</p>
				...
				<div class="catalog__item"><a class="catalog__link" href="#"></a>
					<div class="catalog__img"><img src="<?php echo bloginfo( 'template_url' ); ?>/assets/images/catalog/4.jpg" alt="Аренда экскаваторов CATERPILLAR" /></div><a
						class="catalog__button" href="#">Подробнее</a>
					<div class="catalog__info">
						<h4 class="catalog__header">Аренда экскаваторов CATERPILLAR</h4>
						<div class="catalog__options">
				...
				<div class="catalog__item"><a class="catalog__link" href="#"></a>
					<div class="catalog__img"><img src="<?php echo bloginfo( 'template_url' ); ?>/assets/images/catalog/5.jpg" alt="Аренда погрузчиков CATERPILLAR" /></div><a
						class="catalog__button" href="#">Подробнее</a>
					<div class="catalog__info">
						<h4 class="catalog__header">Аренда погрузчиков CATERPILLAR</h4>
						<div class="catalog__options">
							<div class="catalog__feature">
								<p class="catalog__name">Объём фронтального ковша</p>
								<p class="catalog__value">1,3 м3</p>
				...
				<div class="catalog__item"><a class="catalog__link" href="#"></a>
					<div class="catalog__img"><img src="<?php echo bloginfo( 'template_url' ); ?>/assets/images/catalog/6.jpg" alt="Аренда фронтальных погрузчиков CATERPILLAR" /></div><a
						class="catalog__button" href="#">Подробнее</a>
					<div class="catalog__info">
						<h4 class="catalog__header">Аренда фронтальных погрузчиков CATERPILLAR</h4>
						<div class="catalog__options">
							<div class="catalog__feature">
								<p class="catalog__name">Объём фронтального ковша</p>
								<p class="catalog__value">1,3 м3</p>
				...
				<div class="catalog__item"><a class="catalog__link" href="#"></a>
					<div class="catalog__img"><img src="<?php echo bloginfo( 'template_url' ); ?>/assets/images/catalog/7.jpg" alt="Аренда колёсных экскаваторов CATERPILLAR" /></div><a
						class="catalog__button" href="#">Подробнее</a>
					<div class="catalog__info">
						<h4 class="catalog__header">Аренда колёсных экскаваторов CATERPILLAR</h4>
						<div class="catalog__options">
							<div class="catalog__feature">
								<p class="catalog__name">Объём фронтального ковша</p>
								<p class="catalog__value">1,3 м3</p>
				...
				<div class="catalog__item"><a class="catalog__link" href="#"></a>
					<div class="catalog__img"><img src="<?php echo bloginfo( 'template_url' ); ?>/assets/images/catalog/8.jpg" alt="Аренда тралов CATERPILLAR" /></div><a
						class="catalog__button" href="#">Подробнее</a>
					<div class="catalog__info">
						<h4 class="catalog__header">Аренда тралов CATERPILLAR</h4>
						<div class="catalog__options">
							<div class="catalog__feature">
								<p class="catalog__name">Объём фронтального ковша</p>
								<p class="catalog__value">1,3 м3</p>
				...
				<div class="catalog__item"><a class="catalog__link" href="#"></a>
					<div class="catalog__img"><img src="<?php echo bloginfo( 'template_url' ); ?>/assets/images/catalog/9.jpg" alt="Аренда грунтовых катков CATERPILLAR" /></div><a
						class="catalog__button" href="#">Подробнее</a>
					<div class="catalog__info">
						<h4 class="catalog__header">Аренда грунтовых катков CATERPILLAR</h4>
						<div class="catalog__options">
							<div class="catalog__feature">
								<p class="catalog__name">Объём фронтального ковша</p>
								<p class="catalog__value">1,3 м3</p>
				...
				<div class="catalog__item"><a class="catalog__link" href="#"></a>
					<div class="catalog__img"><img src="<?php echo bloginfo( 'template_url' ); ?>/assets/images/catalog/10.jpg" alt="Аренда автокранов CATERPILLAR" /></div><a
						class="catalog__button" href="#">Подробнее</a>
					<div class="catalog__info">
						<h4 class="catalog__header">Аренда автокранов CATERPILLAR</h4>
						<div class="catalog__options">
							<div class="catalog__feature">
								<p class="catalog__name">Объём фронтального ковша</p>
								<p class="catalog__value">1,3 м3</p>
				...
				<div class="catalog__item"><a class="catalog__link" href="#"></a>
					<div class="catalog__img"><img src="<?php echo bloginfo( 'template_url' ); ?>/assets/images/catalog/11.jpg" alt="Аренда автогрейдеров CATERPILLAR" /></div><a
						class="catalog__button" href="#">Подробнее</a>
					<div class="catalog__info">
						<h4 class="catalog__header">Аренда автогрейдеров CATERPILLAR</h4>
						<div class="catalog__options">
							<div class="catalog__feature">
								<p class="catalog__name">Объём фронтального ковша</p>
								<p class="catalog__value">1,3 м3</p>
				...
				<div class="catalog__item"><a class="catalog__link" href="#"></a>
					<div class="catalog__img"><img src="<?php echo bloginfo( 'template_url' ); ?>/assets/images/catalog/12.jpg" alt="Аренда телескопических погрузчиков CATERPILLAR" /></div><a
						class="catalog__button" href="#">Подробнее</a>
					<div class="catalog__info">
						<h4 class="catalog__header">Аренда телескопических погрузчиков CATERPILLAR</h4>
						<div class="catalog__options">
							<div class="catalog__feature">
								<p class="catalog__name">Объём фронтального ковша</p>
								<p class="catalog__value">1,3 м3</p>
				...
				<div class="catalog__item"><a class="catalog__link" href="#"></a>
					<div class="catalog__img"><img src="<?php echo bloginfo( 'template_url' ); ?>/assets/images/catalog/13.jpg" alt="Аренда мини-техники CATERPILLAR" /></div><a
						class="catalog__button" href="#">Подробнее</a>
					<div class="catalog__info">
						<h4 class="catalog__header">Аренда мини-техники CATERPILLAR</h4>
						<div class="catalog__options">
							<div class="catalog__feature">
								<p class="catalog__name">Объём фронтального ковша</p>
								<p class="catalog__value">1,3 м3</p>
				...
				<div class="catalog__item"><a class="catalog__link" href="#"></a>
					<div class="catalog__img"><img src="<?php echo bloginfo( 'template_url' ); ?>/assets/images/catalog/14.jpg" alt="Аренда гидромолотов CATERPILLAR" /></div><a
						class="catalog__button" href="#">Подробнее</a>
					<div class="catalog__info">
						<h4 class="catalog__header">Аренда гидромолотов CATERPILLAR</h4>
						<div class="catalog__options">
							<div class="catalog__feature">
								<p class="catalog__name">Объём фронтального ковша</p>
								<p class="catalog__value">1,3 м3</p>
				...
				<div class="catalog__item"><a class="catalog__link" href="#"></a>
					<div class="catalog__img"><img src="<?php echo bloginfo( 'template_url' ); ?>/assets/images/catalog/15.jpg" alt="Аренда буровой техники CATERPILLAR" /></div><a
						class="catalog__button" href="#">Подробнее</a>
					<div class="catalog__info">
						<h4 class="catalog__header">Аренда буровой техники CATERPILLAR</h4>
						<div class="catalog__options">
							<div class="catalog__feature">
								<p class="catalog__name">Объём фронтального ковша</p>
								<p class="catalog__value">1,3 м3</p>
		...
		<div class="container">
			...
			<div class="need__wrapper">
				...
				<ul class="need__list">
					...
					<li><img src="<?php echo bloginfo( 'template_url' ); ?>/assets/images/need/line.svg" alt=""><span>возведение жилой, коммерческой недвижимости, промышленных объектов;</span>
					</li>
